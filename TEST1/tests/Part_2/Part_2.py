...
from sprint_challenge import Part_2 

"""
Part 2.1 - Schema Testing
"""
...
def test_user_table(test_cursor):
    ...
    cur = test_cursor
    cur.execute(Part_2.CREATE_USER_TABLE)
...
def test_product_table(test_cursor):
    ...
    cur = test_cursor
    cur.execute(Part_2.CREATE_PRODUCT_TABLE)
...
def test_join_table(test_cursor):
    ...
    cur = test_cursor
    cur.execute(Part_2.CREATE_USER_PRODUCT_TABLE)
...
def test_question_1(get_answer):
    ...
    assert get_answer(Part_2.SQL_QUERY_1) == expected_answer

def test_question_2(get_answer):
    expected_answer = [(37.22222222222222,)]

    assert get_answer(Part_2.SQL_QUERY_2) == expected_answer
...
def test_question_3(get_answer):
    ...
    assert get_answer(Part_2.SQL_QUERY_3) == expected_answer

def test_question_4(get_answer):
    expected_answer = [('Confections',)]

    assert get_answer(Part_2.SQL_QUERY_4) == expected_answer
...
def test_question_5(get_answer):
    ...
    assert get_answer(Part_2.SQL_QUERY_5) == expected_answer

def test_question_6(get_answer):
    expected_answer = [(7, 'King', 10)]

    assert get_answer(Part_2.SQL_QUERY_6) == expected_answer
